...
public abstract class AbstractLogic2InputElement extends AbstractLogicElement {

   Element firstInput;
   Element secondInput;

   public AbstractLogic2InputElement(
         final List<List<CubeElement>> singularityCubes,
   ...
   public List<Map<String, CubeElement>> runDAlgorithmInternal(List<Map<String, CubeElement>> cubes, Element fromElement) {
      ...
      if (fromElement.equals(this.firstInput) && this.secondInput instanceof LogicElement) {
         intermediateResult = ((LogicElement) this.secondInput).applySingularityCubesR(intermediateResult);
      }
      else if (fromElement.equals(this.secondInput) && this.firstInput instanceof LogicElement) {
   ...
   public List<String> getElementsNames() {
      return of(firstInput.getName(), secondInput.getName(), this.getName());
   }
